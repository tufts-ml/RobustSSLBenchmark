...
parser.add_argument('--root', type=str, default='./data/cifar-10-python')
...
f=open("CIFAR10"+'_class'+'_labels_'+str(labels)+'_'+str(iteration)+'.csv', "w", encoding="utf-8")
...
for rate in rate_list:
        ...
        meta_network = ResNet50Fc(num_classes=num_classes//2, output_feature=False)
        ...
        for name,algorithm in algorithms.items():
            ...
            for seed in range(3):
                ...
                set_seed(seed)
                S_X, S_y = all_labeled_X[all_labeled_y < int(num_classes / 2)], all_labeled_y[all_labeled_y <int( num_classes / 2)]
                T_X, T_y = all_labeled_X[all_labeled_y >= int(num_classes / 2)], all_labeled_y[all_labeled_y >= int(num_classes / 2)]
